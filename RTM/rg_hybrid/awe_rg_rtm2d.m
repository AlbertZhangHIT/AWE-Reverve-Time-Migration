function [rfl, image, normal] = awe_rg_rtm2d(nz, nx, nt, dz, dx, dt, npml, v, sxz, gxz, wfdDir, varargin)
...
if ~isempty(records)
    for ishot = 1:ns
        ...
        [corr, illum] = rg_rtm(nz, nx, nt, dz, dx, dt, npml, v, sxz(ishot,:), gxz, record, wfdFile, ...
