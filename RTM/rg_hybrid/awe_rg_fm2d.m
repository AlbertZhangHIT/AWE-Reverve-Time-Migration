function [out] = awe_rg_fm2d( nz, nx, nt, dz, dx, dt, npml, v, wlt, sxz, gxz, varargin )
...
if (writeRecord && writeWfd) 
    for ishot = 1 : ns
        ...
        tmp = rg_fd(nz, nx, nt, dz, dx, dt, npml, v, wlt, sxz(ishot, :), gxz, 'recordfile', recordFile, ...
...
if (~writeRecord && writeWfd) 
    ...
    for ishot = 1 : ns
        ...
        tmp = rg_fd(nz, nx, nt, dz, dx, dt, npml, v, wlt, sxz(ishot, :), gxz, ...
                'wfdfile', wfdFile, 'show', showImage, 'display', displayFreq);
